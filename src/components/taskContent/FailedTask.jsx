...
const FailedTask = ({ el }) => {
    return (
        <div className='group snap-start flex-shrink-0 ease-in-out transition duration-300 hover:scale-110 hover:shadow-black hover:shadow-2xl  overflow-hidden h-80 w-110 bg-red-600 p-5 rounded-2xl cursor-pointer'>
